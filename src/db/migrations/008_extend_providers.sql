-- Phase 5.5: 完整 freellmapi 风格 Provider 集合 (53+ 个, 36 免费)
-- 这是 004_seed_providers.sql 的扩展, 用 OR IGNORE 让重复跑安全
-- 任何用户的自定义 provider 都不会被覆盖
...
-- === 修一些 004 错误的 base_url ===
UPDATE providers SET base_url = 'https://api.mistral.ai/v1' WHERE name = 'mistral-free' AND base_url = 'https://api.mistral.ai/v1';
UPDATE providers SET base_url = 'https://api.groq.com/openai/v1', is_free = 1 WHERE name = 'groq-free';
UPDATE providers SET base_url = 'https://api.cohere.com/v1' WHERE name = 'cohere-trial';
UPDATE providers SET base_url = 'https://models.github.ai/inference' WHERE name = 'github-models';
UPDATE providers SET base_url = 'https://qianfan.baidubce.com/v2' WHERE name = 'baidu-qianfan';
UPDATE providers SET base_url = 'https://ark.cn-beijing.volces.com/api/v3' WHERE name = 'volcengine-ark';
UPDATE providers SET base_url = 'https://spark-api-open.xf-yun.com/v1' WHERE name = 'iflytek-spark';
UPDATE providers SET base_url = 'https://api-inference.modelscope.cn/v1/chat/completions' WHERE name = 'modelscope';
UPDATE providers SET base_url = 'https://gen.pollinations.ai/v1' WHERE name = 'pollinations';
UPDATE providers SET base_url = 'https://integrate.api.nvidia.com/v1' WHERE name = 'nvidia-nim';
UPDATE providers SET base_url = 'https://developer.amd.com.cn/radeon/api/v1' WHERE name = 'amd-radeon';
